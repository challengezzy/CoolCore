...
//    private static Hashtable tableName = new Hashtable();
//    private static Hashtable columnName = new Hashtable();
    //  private static Hashtable mapAK = new Hashtable();
    //  private static Hashtable mapFK = new Hashtable();
